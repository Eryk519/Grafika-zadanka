...
print("typ danych tablicy:", obrazek_dane.dtype)
print("rozmiar tablicy:", obrazek_dane.shape)
print("liczba elementow:", obrazek_dane.size)
print("wymiar tablicy:", obrazek_dane.ndim)
print("rozmiar wyrazu tablicy:",
      obrazek_dane.itemsize)
print("pierwszy wyraz:", obrazek_dane[30][50])
print("drugi wyraz:", obrazek_dane[40][90])
print("trzeci wyraz:", obrazek_dane[0][99])
print("***************************************")
print(obrazek_dane)
